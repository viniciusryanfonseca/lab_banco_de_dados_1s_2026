...
JOIN
    ...
    /*
    PARA TODOS UM USUARIO ESPECIFICO
    */
    SELECT 
		COUNT(*)
	FROM 
	...
	WHERE 
        ...
        /*
    PARA TODOS TODOS OS USUARIOs             USUARIO t2 ON (t1.ID_USUARIO = t2.ID_USUARIO)    CATEGORIA t2 ON (t1.ID_CATEGORIA = t2.ID_CATEGORIA)
   t1.ID_USUARIO,
		t1.ID_CATEGORIA,
        t2.NOME AS NOME,
    ...
    */
    /*
    Consulta nome, o id, ano do livro mais recente, mais antigo, soma dos livros lidos, contar livro total de cada usuario e percentual de livros lidos em cima dos obtidos
    */
    SHOW TABLES;
    SELECT 
		t1.ID_USUARIO,
        ...
        ROUND((SUM(t1.LIDO)/ (SELECT COUNT(t1.ID_LIVRO)))*100, 2) AS PCT_LIDO,
...
/*Livros lidos por titulos*/
CREATE OR REPLACE VIEW livros_lidos AS (
SELECT 
	TITULO,
    LIDO
FROM 
...
/*Para melhorar a performance vamos criar um storage precedure
